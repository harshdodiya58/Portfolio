...
const Projects = () => {
        ...
        <div className={`relative h-full rounded-2xl overflow-hidden border transition-all duration-300 ${
          ...
          <div className="relative z-10 p-7 md:p-8 h-full flex flex-col">
            ...
            <motion.p
              ...
              className={`text-sm md:text-base leading-relaxed mb-5 flex-grow line-clamp-3 md:line-clamp-4 ${
            ...
            <div className="flex gap-3 mt-auto">
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`flex-1 px-4 py-2.5 border-2 font-bold rounded-lg transition-all duration-300 text-center text-sm ${
                  isDark
  ...
  return (
    <section id="projects" className={`py-24 relative overflow-hidden transition-colors duration-300 ${
      isDark ? 'bg-gray-900' : 'bg-gradient-to-b from-white via-blue-50/50 to-white'
    }`}>
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className={`absolute -top-40 -left-40 w-80 h-80 rounded-full blur-3xl ${
            isDark ? 'bg-blue-900/10' : 'bg-blue-300/10'
          }`}
          animate={{ 
            x: [0, 80, 0],
            y: [0, 40, 0]
        ...
        <motion.div
          className={`absolute -bottom-40 -right-40 w-80 h-80 rounded-full blur-3xl ${
            isDark ? 'bg-purple-900/10' : 'bg-purple-300/10'
          }`}
          animate={{ 
            x: [0, -80, 0],
            y: [0, -40, 0]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <motion.div className={`h-0.5 w-12 ${
              isDark 
