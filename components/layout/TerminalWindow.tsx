...
export const TerminalWindow = () => {
  ...
  return (
    <motion.div
      ...
      className={`crt glass-panel flex flex-col shadow-2xl shadow-black/50 overflow-hidden
        ${isMaximized
          ? 'fixed inset-0 !w-full !h-full !max-w-none !max-h-none !rounded-none z-50'
          : 'relative w-[95%] sm:w-[90%] md:w-[85%] h-[85vh] sm:h-[80vh] max-w-[1200px] max-h-[800px] rounded-xl'}`}
      style={{
        zIndex: 10,
      }}
    >
